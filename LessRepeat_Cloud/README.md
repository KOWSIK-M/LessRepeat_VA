...
| Console | LessRepeat Studio | Zero-dependency Node app, agent builder plus voice studio |
...
dashboard/                  LessRepeat Studio, no build step and one dependency
```
...
Built by [LessRepeat](https://rapidxai.com). MIT licensed. Dograh is separately
