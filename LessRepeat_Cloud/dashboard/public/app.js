'use strict';
/* LessRepeat Studio , front-end. Talks only to our own /api/* (keys stay server-side). */
...
function addBubble(role, text) {
  ...
  b.innerHTML = `<span class="who">${role === 'user' ? 'you' : 'lessrepeat'}</span>${text}`;
...
/* ===== LessRepeat promo popup + owner off-switch ===== */
(function promos() {
