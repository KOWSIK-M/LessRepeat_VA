...
Do not open a public issue containing credentials, customer data, call recordings, transcripts, or an exploitable vulnerability. Contact LessRepeat privately through the contact route on [rapidxai.com](https://rapidxai.com).
