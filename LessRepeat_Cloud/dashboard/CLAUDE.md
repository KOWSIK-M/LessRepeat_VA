# LessRepeat. Repo guide for future sessions.
...
A premium, multi-tenant, provider-agnostic AI voice agent platform, branded **LessRepeat**.
...
rapidx-voice-studio/
  ...
  public/
    ...
    assets/
      ...
      logo.svg              # LessRepeat wordmark with voltage waveform glyph (Ops)
