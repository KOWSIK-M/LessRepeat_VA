# LessRepeat Design Contract

## 1. Product posture

LessRepeat is the operating surface for a high-end automation agency. It must feel calm, exact, and financially literate. The product combines client operations, voice agents, revenue, invoices, integrations, support, and system prompts without making unavailable integrations appear live.
